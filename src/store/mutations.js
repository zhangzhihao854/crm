import {TEST_DATA,SUBMIT,TEXT_SATA} from './mutation-types.js'
...
export default {
  [TEXT_SATA](state,params){

  },

  [TEST_DATA](state,params){
     // console.log("测试数据------->");
     // // data =  getTestData().then((res)=>{
     //  console.log(data);
    ...
    getTestData(url,params).then((res)=>{
      if(res.status==1001)
      {
  ...
  [SUBMIT](state,resultData){
    state.selectArray = resultData;
  }
	// // 记录当前经度纬度
