...
//      isInit:false
    ...
    watch: {
      selectValue: function (newVal) {
        console.log("calendear-input------>"+newVal);
        //修改日期格式 xx-xx-xx
    ...
    activated() {
      console.log("updated---->"+this.$route.query.date);
      ...
      console.log("mounted----》"+this.selectValue);
      var resultDate = "";
      // console.log(month);
      if(month.length===1)
      {
