  ...
  export default {
    ...
    methods: {
      ...
      getNweData(){
        ...
        if(this.dataSize <= 3){
          document.getElementById("echartContainer5").style.height = document.documentElement.clientHeight + "px";
        }else{
          document.getElementById("echartContainer5").style.height = this.cavHeight+"px";
        }
        let myChart = echart.init(document.getElementById('echartContainer5'));//初始化
        let  option = {
         /* title: {
            subtext: '单位/亿',
            subtextStyle: {
