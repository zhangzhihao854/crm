    ...
    <div class="temp">
      ...
      <div style="margin-top: 50px;">
        <div class="mui-input-row mui-search">
          ...
          <input type="search" class="mui-input-clear" placeholder="请输入存款客户名称" v-model="custName" @keyup.enter="valueck">
        </div>
  ...
  import BackHeader from '@/components/header/back-header'
    export default{
      ...
      activated(){
        ...
        this.chooseListdata=[]
        this.chooseval=[]
        this.$store.state.markingckdata=[]//每次上来制空vuex里面存的数据
          this.valueck()
      },
      methods:{
        valueck(){
//          this.getCheckBoxRes("checkipt")
        ...
        fsvalue(){
          this.getCheckBoxRes("checkipt")
          this.$store.state.markingckdata=this.chooseval
          this.$router.push("moreActivityContDetail")
