...
<script>
  ...
  export default {
    ...
    data () {
      return {
        title:'高管看板',
        titleCont:[{context:'贷款情况分析表',linkPath:'/echartsBoxC',src:require('../../../static/images/贷款@3x.png')},{context:'存款情况分析表',linkPath:'/echartsBoxCC',src:require('../../../static/images/存款@3x.png')}],
        currentDate:'',
        calendar1:{
