...
<script>
  ...
  export default {
    ...
    data () {
      return {
        title:'高管看板',
        titleCont:[{context:'贷款情况分析表',linkPath:'/echartsBoxB',src:require('../../../static/images/贷款@3x.png')},{context:'存款情况分析表',linkPath:'/echartsBoxBB',src:require('../../../static/images/存款@3x.png')}],
