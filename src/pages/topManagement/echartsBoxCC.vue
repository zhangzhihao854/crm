<template>
  <div class="toMainHeader">
    <div class="topHeader">
      <back-Header :title="title" :dataType="dataType"  :currentTime="currentTime" :mark="mark"></back-Header>
    </div>
    <div class="navCont">
...
<script>
  import BackHeader from '@/components/header/right-header-btn2'
...
//          {value:'零售存款合计',textStyle:{color:"#A4A8AB",backgroundColor:"#fff"}},
    ...
    methods:{
     /* goEcharts(){
        this.$router.push('/echartsBoxCCxq?dataType='+this.dataType+'&currentTime='+this.currentTime);
      },*/
      ...
      //发送请求,获取数据
      getNewsListData(){
        var url= `/CRMNewMobile/admiSubbranch/queryAdmiCompaDeposits`;
        ...
        this.dataType = this.ListData[1].departmentName;
