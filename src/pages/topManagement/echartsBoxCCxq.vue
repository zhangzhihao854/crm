...
//          {value:'',textStyle:{color:"#A4A8AB",backgroundColor:"#fff"}}
        ],
        dataArray:[],
        dataText:[
        ],
    ...
    activated(){
      ...
      if(this.dataType=="存款合计"){
        this.showdata=true;
        this.showdatamore=false
        this.getNewsListData("admiSubbranch/queryAdmiCompaDepositsLL");
      }else if(this.dataType=="对公存款合计"){
        this.showdata=false;
        this.showdatamore=true
        this.getNewsListData("admiSubbranch/admiQueryRetailDeposits");
      }else if(this.dataType=="零售存款合计"){
        this.showdata=false;
        this.showdatamore=true
        this.getNewsListData("admiSubbranch/admiRetailDeposits");
      }
      //this.currentTime=this.$route.query.currentTime;
