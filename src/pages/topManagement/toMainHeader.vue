  ...
  export default {
   components:{
    ...
    data () {
      return {
         title:'高管看板',
         titleCont:[{context:'贷款日报表',linkPath:'/echartsBox',src:require('../../../static/images/贷款@3x.png')},{context:'存款日报表',linkPath:'/echartsBoxA',src:require('../../../static/images/存款@3x.png')}],
         currentDate:'',
         calendar1:{
